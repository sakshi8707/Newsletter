...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <title>Newsletter | Mentors</title>
  </head>
    ...
    <div class="container-fluid">
      <div class="row mt-5">
        <div class="col-lg-3 col-md-12 col-sm-12">
          <div class="mt-5">
          <img src="./assets/img/newsletter_img/usaid_student.jpg" alt="" class="img-fluid mx-auto d-block">
          </div>
          <div>
            <h3 class="text-center mentor-name">June Osborn</h3>
            <p class="text-center mentor-desg">Mentor</p>
          </div>
        </div>
        <div class="col-lg-9 col-md-12 col-sm-12">
        <div class="d-flex row text-justify px-3 py-5 mentor-content m-0 bg-white">
